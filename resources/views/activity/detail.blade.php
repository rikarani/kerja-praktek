  ...
  <main class="bg-white pb-16 pt-8 antialiased lg:pb-24 lg:pt-16 dark:bg-gray-900">
    <div class="mx-auto flex max-w-screen-xl justify-between px-4">
      <article
            ...
            <div class="mr-3 inline-flex items-center text-sm text-gray-900 dark:text-white">
              ...
              <div>
                ...
                <p class="text-base text-gray-500 dark:text-gray-400">
                  <time>{{ $activity->start_date->translatedFormat('d F Y') }}</time>
                </p>
              </div>
            </div>
          </address>
        ...
        <h2>Video</h2>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat porro minus eius amet rerum voluptatibus
          impedit optio vero dignissimos sint nihil quasi, ipsum eum nemo eos tenetur veritatis tempore esse.
        </p>
      </article>
    </div>
  </main>
    ...
    <div class="mx-auto max-w-screen-xl px-4">
      ...
      <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        <article class="max-w-xs">
          <a href="#">
            <img class="mb-5 rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-1.png"
              alt="Image 1">
          </a>
        ...
        <article class="max-w-xs">
          <a href="#">
            <img class="mb-5 rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-2.png"
              alt="Image 2">
          </a>
          <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
        ...
        <article class="max-w-xs">
          <a href="#">
            <img class="mb-5 rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-3.png"
              alt="Image 3">
          </a>
          <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
        ...
        <article class="max-w-xs">
          <a href="#">
            <img class="mb-5 rounded-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-4.png"
              alt="Image 4">
          </a>
          <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
  ...
  <footer class="bg-white antialiased dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl p-4 py-6 md:p-8 lg:p-10">
      ...
      <div class="text-center">
        <a class="mb-5 flex items-center justify-center text-2xl font-semibold text-gray-900 dark:text-white"
          href="#">
        ...
        <span class="block text-center text-sm text-gray-500 dark:text-gray-400">© 2021-2022 <a class="hover:underline"
            href="#">Flowbite™</a>. All Rights Reserved.
        </span>
