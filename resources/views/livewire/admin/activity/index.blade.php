...
<div
  ...
  <div class="w-full overflow-x-auto">
    ...
    @else
              ...
              <td class="flex gap-1.5 py-3">
                <div class="group relative inline-block">
                  <a class="bg-brand-500 hover:bg-brand-600 shadow-theme-xs inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 px-4 py-2.5 text-white dark:border-gray-700"
                    href="{{ route('admin.activity.detail', ['activity' => $activity]) }}">
                ...
                <div class="group relative inline-block">
                  <a class="bg-blue-light-500 hover:bg-blue-light-600 shadow-theme-xs inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 px-4 py-2.5 text-white dark:border-gray-700"
                    href="{{ route('admin.activity.preview', ['activity' => $activity]) }}">
                    <svg class="size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      stroke-width="1.5" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round"
      ...
      @endif
      <livewire:modal.admin.activity.publish />
      <livewire:modal.admin.activity.unpublish />
