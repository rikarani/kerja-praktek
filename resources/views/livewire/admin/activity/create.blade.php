@if ($categories->isEmpty())
  <div class="mt-4 grid h-72 place-items-center">
    <div class="text-center">
      <h6 class="text-xl font-medium">Belum Ada Kategori Kegiatan</h6>
      <a class="underline underline-offset-4" href="{{ route('category.index') }}">
        Silahkan Tambah Kategori Terlebih Dahulu
      </a>
    </div>
  </div>
@else
