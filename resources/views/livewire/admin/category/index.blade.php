<div
  class="dark:bg-white/3 overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 sm:px-6 dark:border-gray-800">
    ...
    <div class="flex items-center gap-3">
      <div class="relative flex-1 sm:flex-auto">
        ...
        <input
          ...
          type="text" wire:model.live="search" placeholder="Cari Kategori...">
      </div>
      <button
        ...
        type="button" @click="$dispatch('create-category')">
              ...
              <td class="space-y-2 py-3">
                <div class="gap-2">
                  <button
                    ...
                    @click="$dispatch('update-category', { category: '{{ $category->slug }}' })">
                  ...
                  <button
                    ...
                    type="button" x-data="{ canDelete: {{ $category->activities->count() === 0 ? 'true' : 'false' }} }"
                    @click="canDelete ? $dispatch('delete-category', { category: '{{ $category->slug }}' }) : Toaster.error('Kategori tidak dapat dihapus karena masih memiliki kegiatan')">
                    <svg class="size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      stroke-width="1.5" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round"
  ...
  <livewire:modal.admin.category.create />
  <livewire:modal.admin.category.update />
  <livewire:modal.admin.category.delete />
</div>
