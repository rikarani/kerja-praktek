  ...
  <div class="w-full overflow-x-auto">
    @if ($users->isEmpty())
      <div class="py-4 text-center">
        <p class="text-gray-500 dark:text-gray-400">Belum Ada Operator</p>
      </div>
    @else
              ...
              <td class="space-y-2 py-3">
                <div class="gap-2">
                  ...
                  <button
                    ...
                    type="button" x-data="{ canDelete: {{ $user->activities->count() > 0 ? 'false' : 'true' }} }"
                    @click="canDelete ? $dispatch('delete-user', { user: '{{ $user->id }}'}) : Toaster.error('Tidak dapat menghapus user karena memiliki aktivitas')">
                    <svg class="size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      stroke-width="1.5" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round"
