  ...
  <div class="flex flex-col gap-x-6 gap-y-5">
    <div>
      ...
      <input
        ...
        type="text" wire:target="submit" required wire:loading.attr="disabled" wire:model="name" placeholder="udin petot">
      @error('name')
    ...
    <div>
      ...
      <input
        ...
        type="password" wire:target="submit" wire:loading.attr="disabled" wire:model="password" placeholder="********">
      <p class="text-theme-xs mt-1.5">
        opsional
      </p>
      @error('password')
        <p class="text-theme-xs text-error-500 mt-1.5">
