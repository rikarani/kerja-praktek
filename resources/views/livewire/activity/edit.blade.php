<form class="mt-4 space-y-4">
    ...
    <div class="flex-1">
      ...
      <div class="relative">
        <input
          ...
          id="title" type="text" required wire:model="title" wire:loading.attr="disabled" wire:target="save"
          placeholder="makan siang gratis">
        @error('title')
    ...
    <div class="flex-1">
      ...
      <div class="relative z-20 bg-transparent">
        <select
          ...
          wire:loading.attr="disabled" wire:target="save" required wire:model="category_id">
          <option class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" value="" disabled selected>
            Pilih Opsi
          </option>
          @foreach ($categories as $category)
            <option class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" value="{{ $category->id }}"
  ...
  <div>
    ...
    <textarea
      ...
      required wire:loading.attr="disabled" wire:target="save" wire:model="excerpt" placeholder="singkat saja"
      rows="2"></textarea>
    @error('excerpt')
  ...
  <div class="space-y-4 md:flex md:justify-end md:gap-4 md:space-y-0">
    <div class="w-full md:w-auto">
      <button
        class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex items-center justify-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium text-white disabled:opacity-50"
        type="button" wire:click="save" wire:loading.attr="disabled" wire:target="save">
