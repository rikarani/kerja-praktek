  ...
  <div class="text-center">
    <div class="z-1 relative mb-7 flex items-center justify-center">
      ...
      <span class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <svg class="fill-error-600 dark:fill-error-500" width="38" height="38" viewBox="0 0 38 38" fill="none"
          xmlns="http://www.w3.org/2000/svg">
    ...
    <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">
      Yakin mau hapus user <span class="font-semibold">{{ $user?->name }}</span>?
    </p>
    <div class="mt-7 flex w-full items-center justify-center gap-3">
      <button
        class="bg-error-500 shadow-theme-xs hover:bg-error-600 flex w-full justify-center gap-2 rounded-lg px-4 py-3 text-sm font-medium text-white sm:w-auto"
        type="button" wire:click="hapus">
        <div role="status" wire:loading wire:target="hapus">
