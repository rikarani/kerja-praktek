  ...
  <form wire:submit="rename">
    <div class="mb-4 flex-1">
      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" for="title"
        wire:loading.class="opacity-50" wire:target="rename">
        Nama Baru <span class="text-red-500">*</span>
      </label>
      <div class="relative">
        <input
          ...
          id="title" type="text" autofocus required wire:model="new" wire:loading.attr="disabled"
    ...
    <div class="flex w-full justify-end">
      <button
        ...
        type="submit" wire:loading.attr="disabled" wire:target="rename">
        <div role="status" wire:loading wire:target="rename">
        ...
        <span wire:loading.remove wire:target="rename">
