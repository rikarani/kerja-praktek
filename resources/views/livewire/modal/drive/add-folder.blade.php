<x-partial.modal name="add-folder">
  <form wire:submit="addFolder">
    <div class="mb-4 flex-1">
      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" for="title"
        wire:loading.class="opacity-50" wire:target="add-folder">
      ...
      <div class="relative">
        <input
          ...
          id="title" type="text" autofocus required wire:model="title" wire:loading.attr="disabled"
          wire:target="addFolder" placeholder="......">
        @error('title')
    ...
    <div class="flex w-full justify-end">
      <button
        ...
        type="submit" wire:loading.attr="disabled" wire:target="addFolder">
        <div role="status" wire:loading wire:target="addFolder">
        ...
        <span wire:loading.remove wire:target="addFolder">
