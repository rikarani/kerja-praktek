    ...
    <a href="/">
      <span class="logo space-y-2" :class="sidebarToggle ? 'hidden' : ''">
        ...
        <div class="text-center">
          ...
          <p class="text-theme-sm">Informatika UNTAN</p>
        </div>
      </span>
    ...
    <nav>
      <div>
        <h3 class="mb-4 text-xs uppercase leading-5 text-gray-400">
          ...
          <svg class="menu-group-icon mx-auto fill-current" :class="sidebarToggle ? 'lg:block hidden' : 'hidden'"
        ...
        <ul class="mb-6 flex flex-col gap-4">
          @role('admin')
            <li>
              <a class="menu-item {{ Route::is('category.index') ? 'menu-item-active' : 'menu-item-inactive' }} group"
                href="{{ route('category.index') }}">
                <svg class="{{ Route::is('category.index') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li>
              <a class="menu-item {{ Route::is('user.index') ? 'menu-item-active' : 'menu-item-inactive' }} group"
                href="{{ route('user.index') }}">
                <svg class="{{ Route::is('user.index') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z"
                    fill="" />
            ...
            <li>
              <a class="menu-item {{ Route::is('dashboard') ? 'menu-item-active' : 'menu-item-inactive' }} group"
                ...
                <svg class="{{ Route::is('dashboard') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li>
              <a class="menu-item {{ Route::is('activity.index') || Route::is('activity.create') ? 'menu-item-active' : 'menu-item-inactive' }} group"
                ...
                <svg class="{{ Route::is('activity') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z"
                    fill="" />
          ...
          @endrole
          <li>
            <a class="menu-item {{ Route::is('profile.edit') ? 'menu-item-active' : 'menu-item-inactive' }} group"
              href="{{ route('profile.edit') }}">
              <svg class="{{ Route::is('profile.edit') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
