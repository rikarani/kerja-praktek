  ...
  <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
    <div
      ...
      <button
        ...
        <svg class="fill-current lg:hidden" :class="sidebarToggle ? 'hidden' : 'block lg:hidden'" width="24"
        ...
        <!-- cross icon -->
        <svg class="fill-current" :class="sidebarToggle ? 'block lg:hidden' : 'hidden'" width="24" height="24"
      ...
      <a class="lg:hidden" href="/">
        <img class="dark:hidden" src="{{ asset('images/edoxid.png') }}" alt="Logo" />
    ...
    <div
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
          ...
          <svg class="stroke-gray-500 dark:stroke-gray-400" :class="dropdownOpen && 'rotate-180'" width="18"
        ...
        <div
          ...
          <ul class="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4 dark:border-gray-800">
            <li>
              <a class="text-theme-sm group flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
