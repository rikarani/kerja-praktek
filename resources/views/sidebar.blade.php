    ...
    <nav>
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-4">
          <!-- Menu Item Dashboard -->
          <li>
            <a href="{{ route('dashboard') }}" class="menu-item {{ Route::is('dashboard') ? 'menu-item-active' : 'menu-item-inactive' }} group">
              <svg class="{{ Route::is('dashboard') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <!-- Menu Item Calendar -->
          <li>
            <a href="{{ route('kegiatan.index') }}" class="menu-item {{ Route::is('kegiatan.index') || Route::is('kegiatan.create') ? 'menu-item-active' : 'menu-item-inactive' }} group">
              <svg class="{{ Route::is('kegiatan') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
