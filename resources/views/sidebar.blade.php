                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}"
                            ...
                            class="menu-item group {{ Route::is('dashboard') ? 'menu-item-active' : 'menu-item-inactive' }}">
                    ...
                    <!-- Menu Item Calendar -->
                    <li>
                        <a href="#" @click="selected = 'Kegiatan'; page = 'kegiatan'" class="menu-item group"
                            :class="(selected === 'Kegiatan') && (page === 'kegiatan') ? 'menu-item-active' :
                            'menu-item-inactive'">
                            <svg :class="(selected === 'Kegiatan') && (page === 'kegiatan') ? 'menu-item-icon-active' :
